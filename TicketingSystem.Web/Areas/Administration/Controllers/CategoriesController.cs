namespace TicketingSystem.Web.Areas.Administration.Controllers.Base
{
    ...
    using ViewModel = TicketingSystem.Web.Areas.Administration.ViewModels.Categories.CategoryViewModel;
